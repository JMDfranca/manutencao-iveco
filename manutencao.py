def manutencao(*args, **kwargs):
    ...
    if distance_treted == 72 and utilization =="Sim":
        tipo_plano = "Plano de manutenção recomendado: Revisões a cada 500h \n"
    elif distance_treted == 72 and utilization =="Não":
        tipo_plano = "Plano de manutenção recomendado: Revisões a cada 20.000 km \n"
